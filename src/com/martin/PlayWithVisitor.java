...
import com.martin.visitor.Visitor;
import com.martin.visitor.VisitorBuilder;
import com.martin.visitor.model.Body;
import com.martin.visitor.model.Car;
import com.martin.visitor.model.Engine;
...
public class PlayWithVisitor {
    ...
    public static void main(String[] args) {
        ...
        Consumer<VisitorBuilder<String>> consumer =
                Visitor.<Car, String>forType(Car.class).execute((Car c) -> "Visiting car color: " + c)
